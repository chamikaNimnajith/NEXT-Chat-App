...
const UserListDialog = () => {
    ...
    useEffect(() => {
        ...
        reader.onload = (e) => setRenderedImage(e.target?.result as string); //e.target?.result is a  Base64-encoded string
        reader.readAsDataURL(selectedImage);
        // After readAsDataURL() finishes, it triggers onload, which then updates renderedImage.
    }, [selectedImage]);
